...
The system MUST provision EC2 instances in AWS with configurable instance types and counts.
...
The system MUST clean up all AWS resources on cluster teardown.
...
- **GIVEN** multiple clusters, **WHEN** the user tears down all clusters, **THEN** every tagged VPC and its resources are removed.
