...
dependencies {
    ...
    implementation("software.amazon.awssdk:auth:2.44.4")
    implementation("software.amazon.awssdk:regions:2.44.4")
    ...
    testImplementation("software.amazon.awssdk:s3:2.44.4")
}
