...
dependencies {
    ...
    implementation("software.amazon.awssdk:auth:2.42.36")
    implementation("software.amazon.awssdk:regions:2.42.36")
    ...
    testImplementation("software.amazon.awssdk:s3:2.42.36")
}
