...
class AWS(
    ...
    fun getAccountId(): String =
        cachedAccountId
            ?: stsClient
                ...
                .also {
                    cachedAccountId = it
                    log.debug { "Retrieved and cached account ID: $it" }
                }
     ...
     */
    fun validateRoleSetup(roleName: String): AWS.RoleValidationResult =
        try {
            val profileResponse =
    ...
    private fun getInstanceProfileOrNull(roleName: String): GetInstanceProfileResponse? =
        try {
    ...
    private fun checkRoleHasPolicies(roleName: String): Boolean {
        val response =
    ...
    internal fun createIamInstanceProfile(
        profileName: String,
        roleName: String,
    ) {
        val retryConfig = RetryUtil.createIAMRetryConfig()
